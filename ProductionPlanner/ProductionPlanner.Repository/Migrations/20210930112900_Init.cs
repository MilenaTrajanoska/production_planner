        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfWS = table.Column<int>(nullable: false),
                    WSCapacity = table.Column<double>(nullable: false),
                    InterOpTime = table.Column<double>(nullable: false),
                    TransportantionAndStorageTime = table.Column<double>(nullable: false),
                    BeginningOfWIP = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Materials_MaterialName", x => x.MaterialName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InProcessTime = table.Column<double>(nullable: false),
                    SetUpTime = table.Column<double>(nullable: false),
                    PreProcessingWaitTime = table.Column<double>(nullable: false),
                    PostProcessingWaitTime = table.Column<double>(nullable: false),
                    SellingPrice = table.Column<double>(nullable: false),
                    TotalMaterialCost = table.Column<double>(nullable: false),
                    WagePerHour = table.Column<double>(nullable: false),
                    VariableOHPerDLHour = table.Column<double>(nullable: false),
                    InterestRate = table.Column<double>(nullable: false),
                    FixedOHPerYear = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Orders_OrderName", x => x.OrderName);
                    table.ForeignKey(
                        name: "FK_Orders_ProductHistories_ProductId",
                        column: x => x.ProductId,
            ...
            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "Id", "BeginningOfWIP", "InterOpTime", "IsSet", "NumberOfWS", "TransportantionAndStorageTime", "WSCapacity", "isValid" },
                values: new object[] { 1L, 0, 0.0, false, 0, 0.0, 4.0, false });
